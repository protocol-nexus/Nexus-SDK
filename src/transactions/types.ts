...
export enum TxMsgTypes {
  SdsAll = "", // All 0
  SdsPrepay = "/nexus.sds.v1.MsgPrepay", // SdsPrepay 5
  SdsFileUpload = "/nexus.sds.v1.MsgFileUpload", // SdsFileUpload 6
}

export enum TxMsgTypes {
  PotVolumeReport = "/nexus.pot.v1.MsgVolumeReport", // PotVolumeReport 7
  PotWithdraw = "/nexus.pot.v1.MsgWithdraw", // PotWithdraw 8
  PotFoundationDeposit = "/nexus.pot.v1.MsgFoundationDeposit", // PotFoundationDeposit 16
}

export enum TxMsgTypes {
  RegisterCreateResourceNode = "/nexus.register.v1.MsgCreateResourceNode", // 11 RegisterCreateResourceNode
  RegisterRemoveResourceNode = "/nexus.register.v1.MsgRemoveResourceNode", // 12 RegisterRemoveResourceNode
  RegisterCreateIndexingNode = "/nexus.register.v1.MsgCreateMetaNode", // 13 RegisterCreateIndexingNode
  RegisterRemoveIndexingNode = "/nexus.register.v1.MsgRemoveMetaNode", // 14  RegisterRemoveIndexingNode
  RegisterIndexingNodeRegistrationVote = "/nexus.register.v1.MsgIndexingNodeRegistrationVote", // 15 RegisterIndexingNodeRegistrationVote
}
...
export const TxMsgTypesMap = new Map<number, string>([
  ...
  [
    HistoryTxType.RegisterCreateResourceNode,
    TxMsgTypes.RegisterCreateResourceNode,
  ],
  [
    HistoryTxType.RegisterRemoveResourceNode,
    TxMsgTypes.RegisterRemoveResourceNode,
  ],
  [
    HistoryTxType.RegisterCreateIndexingNode,
    TxMsgTypes.RegisterCreateIndexingNode,
  ],
  [
    HistoryTxType.RegisterRemoveIndexingNode,
    TxMsgTypes.RegisterRemoveIndexingNode,
  ],
  [
    HistoryTxType.RegisterIndexingNodeRegistrationVote,
    TxMsgTypes.RegisterIndexingNodeRegistrationVote,
  ],
]);
